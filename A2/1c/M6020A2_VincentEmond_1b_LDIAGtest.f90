...
! close(20) 
!----------------------------------------------------------------------------
! Vincent Emond, for M6020 Assignemnt 2, based on hje's program available on course website
! Major changes to the original program: Matrix has been changed to match the one provided in the assignment
!					tolerances have been changed to 10^-10
!					rhs is given as rhs=-1
!----------------------------------------------------------------------------
